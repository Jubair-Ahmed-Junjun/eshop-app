...
<body>
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="index.html"><span>E-Shop</span></a>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
                        ...
                        <li><a href="{{URL::to('/manage_order')}}"><i class="icon-list-alt"></i><span class="hidden-tablet">Order Details</span></a></li>
	...
	<footer>
		...
		<p>
			<span style="text-align:left;float:left">&copy; 2020 <a href="http://bootstrapmaster.com/" alt="Bootstrap Themes">Junjun</a></span>
			<span class="hidden-phone" style="text-align:right;float:right">Powered by: <a href="https://www.linkedin.com/in/jubair-ahmed-junjun-4ab6a0177/" alt="Bootstrap Admin Templates">Jubair Ahmed Junjun</a></span>
		</p>
	...
	<!-- end: JavaScript-->
	    ...
	    <script type="text/javascript" src="{{asset('https://cdn.jsdelivr.net/npm/bootbox@5.4.0/bootbox.all.min.js')}}"></script>
